...
kernel void add(global const int* A, global const int* B, global int* C) {
	...
	C[id] = A[id] + B[id];
	//!! 2.8 KERNELS brought me here.
	//Important to note that other types of device memory will be discussed in further sessions. 
	//!! 2.8.1: Run the kernel code so it does multiplication instead of edition. 
	//Also, revert the kernel values to 10. 
}
